...
angular.module("templates/step2A.html", []).run(["$templateCache", function($templateCache) {
	$templateCache.put("templates/step2A.html",
		'<div>' +
			'<div class="select-blurb" ng-style="{top : position.description.top, left : position.description.left}">' +
			'<div>' +
				'Tell us what you need a {{Request.category}} for<span class="tutorial-microphone-snippet">, or click the <i ui-sref="recording" class="fa fa-microphone"></i> icon to record your description</span>. Provide specific information so we can find you the best match!' +
			'</div>' +
